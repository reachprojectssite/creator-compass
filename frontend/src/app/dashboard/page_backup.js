                ...
                <div className="md:col-span-1">
                  <div className="bg-white rounded-xl border border-slate-200 shadow-md overflow-hidden">
                    ...
                    <div className="border-t border-slate-200">
                      <nav className="p-2">
                        <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg bg-amber-50 text-amber-600 font-medium text-sm">
                          <UserRound size={16} />
                          <span>Profile</span>
                        </button>
                        <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 hover:bg-slate-50 hover:text-slate-900 font-medium text-sm mt-1">
                          <Bell size={16} />
